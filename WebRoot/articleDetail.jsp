...
未结帖：12">结帖率：94.03%</dd>
              ...
              <div class="post_body">
                  <div class="tag"><%= rs.getString("title") %> </div>
                  <br>                  
                 <%= rs.getString("cont") %>
        ...
        <tr>
              <td valign="bottom"><div class="control"> <span class="time"> 发表于：
                <%= new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(rs.getTimestamp("pdate")) %> </span> <strong class="fr"> 楼主 </strong>
          ...
          function post_bury(topic_id,post_id){
              $.ajax({
                  ...
                  <a href="reply.jsp?id=<%= rs.getInt("id") %>&rootid=<%= rs.getInt("rootid") %>&isleaf=<%= rs.getInt("isleaf") %>" class="quote" rel="nofollow">回复</a> | <a href="#quote" class="quote" rel="nofollow">引用</a> | <a href="http://bbs.csdn.net/posts/403055364/report?topic_id=392321225" class="fancybox red report_spam" rel="nofollow">举报 </a> | <span class="manage-toggle">
